    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-8 py-20 ">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-white mb-6">About Helper-Buddy</h1>
      ...
      <div className="py-16">
        <h2 className="text-4xl font-bold text-center mb-16 transform transition-all duration-300 text-slate-300 hover:text-white">
        ...
        <div className="space-y-24">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="w-full md:w-1/2 space-y-4">
                <h3 className="text-3xl font-bold text-white">Home Cleaning Excellence</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col-reverse md:flex-row items-center gap-12">
              <div className="w-full md:w-1/2 space-y-4">
                <h3 className="text-3xl font-bold text-white">Personal Assistance</h3>
                <p className="text-lg text-slate-300">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="w-full md:w-1/2 space-y-4">
                <h3 className="text-3xl font-bold text-white">Technical Support</h3>
                <p className="text-lg text-slate-300">
      ...
      {/* Location Section */}
      <div className="py-16 bg-gradient-to-b from-gray-950 to-stone-950 border-t-2 border-b-2 border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-white">Find Us Here</h2>
